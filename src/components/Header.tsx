    ...
    >
      ...
      <div className="flex items-center gap-[2.2rem]">
        <div className="flex cursor-pointer">
          ...
          <div
            className={`w-[1.5rem] h-[1.5rem] bg-[#ff7e1b] rounded-full flex items-center justify-center relative 
          top-[-5px] left-[-10px] text-[1rem] text-white font-bold opacity-0 transition-opacity duration-500 ease-in-out ${
            purchaseCount > 0 && isPurchaseCountVisible ? "opacity-100" : ""
          }`}
          >
            {purchaseCount}
          </div>
